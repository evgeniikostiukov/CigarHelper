...
- При обращении на русском поясняй дифф и рекомендации **на русском**; текст коммита (subject/body) — на языке, принятом в репозитории (часто английский для conventional commits, если команда не договорилась иначе).

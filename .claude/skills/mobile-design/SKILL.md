---
name: mobile-design
description: Mobile-first design thinking and decision-making for iOS and Android apps. Touch interaction, performance patterns, platform conventions. Teaches principles, not fixed values. Use when building React Native, Flutter, .NET MAUI, or native mobile apps.
...
- При обращении на русском формулируй принципы, чек-листы и рекомендации по UX **на русском**; имена компонентов и API платформ — как в iOS/Android/SDK.

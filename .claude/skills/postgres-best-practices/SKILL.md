...
- При обращении на русском формулируй выводы по схеме и запросам, рекомендации и чек-листы **на русском**; SQL, имена объектов БД и параметры конфигурации — как в Postgres/Supabase.

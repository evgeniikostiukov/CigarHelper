...
- При обращении на русском формулируй разбор промптов, рекомендации и примеры для людей **на русском**; сами промпты для продакшена — на языке целевой модели/продукта, если не оговорено иначе.

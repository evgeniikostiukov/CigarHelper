...
- При обращении на русском формулируй инструкции, выводы по тестам и отчёты **на русском**.
- Имена селекторов, пути файлов и код скриптов — как в проекте (обычно английский).

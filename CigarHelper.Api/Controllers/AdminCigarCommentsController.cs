...
[ApiController]
[Route("api/admin/cigar-comments")]
[Authorize(Roles = "Admin,Moderator")]
[Produces("application/json")]
public class AdminCigarCommentsController : ControllerBase
{
    private readonly ICigarCommentService _comments;

    public AdminCigarCommentsController(ICigarCommentService comments) => _comments = comments;

    [HttpGet]
    [ProducesResponseType(typeof(PaginatedResult<AdminCigarCommentRowDto>), StatusCodes.Status200OK)]
    public async Task<ActionResult<PaginatedResult<AdminCigarCommentRowDto>>> GetPending(

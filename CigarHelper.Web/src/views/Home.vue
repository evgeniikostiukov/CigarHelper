<template>
  <section
    class="home-root -mx-2 sm:mx-0 rounded-2xl sm:rounded-3xl bg-gradient-to-b from-stone-50 via-rose-50/40 to-stone-50 px-3 py-6 ring-1 ring-stone-900/5 dark:from-stone-950 dark:via-rose-950/20 dark:to-stone-950 dark:ring-stone-100/10 sm:px-6 sm:py-8"
    data-testid="home"
    ...
    <div class="relative z-[1] mx-auto max-w-7xl">
      <header class="pb-6 sm:pb-8">
        ...
        <p class="mt-1.5 max-w-2xl text-pretty text-sm text-stone-600 dark:text-stone-400">
          Коллекция сигар и хьюмидоров под рукой: влажность, вместимость и карточки.
        </p>
      </header>
      ...
      <div
        ...
        <p
          ...
          Отслеживайте сигары и условия в хьюмидорах.
        </p>
        ...
        <div
          ...
          <Button
            ...
            class="min-h-12 w-full touch-manipulation shadow-md shadow-rose-900/10 dark:shadow-black/40 sm:w-auto sm:min-h-11"
            icon="pi pi-box"
            label="Мои хьюмидоры"
          ...
          <Button
            ...
            class="min-h-12 w-full touch-manipulation shadow-md shadow-rose-900/10 dark:shadow-black/40 sm:mx-auto sm:w-auto sm:min-w-[12rem] sm:min-h-11"
            icon="pi pi-sign-in"
            label="Начать"
      ...
      <div
        ...
        <article
          ...
          class="home-feature-enter flex min-h-[14rem] flex-col items-center rounded-2xl border border-stone-200/90 bg-white/95 p-6 text-center shadow-md shadow-stone-900/5 transition-[box-shadow,transform] duration-300 hover:border-rose-800/20 hover:shadow-lg hover:shadow-rose-900/10 dark:border-stone-700/90 dark:bg-stone-900/85 dark:shadow-black/50 dark:hover:border-rose-900/30 dark:hover:shadow-black/70 motion-reduce:transition-none motion-reduce:hover:translate-y-0 sm:p-7"
          :style="{ animationDelay: `${Math.min(index, 8) * 48}ms` }">
          <span
            class="mb-4 flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-rose-100/90 text-rose-900 dark:bg-rose-900/40 dark:text-rose-100"
            aria-hidden="true">
            <i
              :class="feature.icon"
              class="text-2xl" />
          </span>
          <h2 class="mb-3 text-xl font-semibold tracking-tight text-stone-900 dark:text-rose-50/95">
            {{ feature.title }}
          </h2>
  ...
  const features = [
    {
      ...
      icon: 'pi pi-box',
      title: 'Хьюмидоры',
      text: 'Храните коллекцию в разных хьюмидорах: влажность и вместимость.',
    },
    {
      testid: 'cigars',
      icon: 'pi pi-star',
      title: 'Сигары',
      text: 'Бренд, формат, крепость, оценка и фото.',
    },
    {
      testid: 'organized',
      icon: 'pi pi-check-circle',
      title: 'Порядок',
      text: 'Видно, в каком хьюмидоре хранится каждая сигара.',
    },
  ] as const;
</script>

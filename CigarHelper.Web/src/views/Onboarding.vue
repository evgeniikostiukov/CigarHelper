      ...
      <header class="flex flex-col gap-4 pb-6 sm:flex-row sm:items-end sm:justify-between sm:pb-8">
        <div class="min-w-0">
          ...
          <p class="mt-1.5 max-w-2xl text-pretty text-sm text-stone-600 dark:text-stone-400">
            Создайте первый хьюмидор и добавьте одну–две сигары из каталога.
          </p>
        </div>
            ...
            <div class="flex items-start justify-between gap-4">
              <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-stone-600 dark:text-stone-400">
                  {{
                    step === 1
                      ? 'Достаточно названия; описание и влажность можно добавить позже.'
                      : 'Выберите одну–две сигары из каталога — они попадут в коллекцию и в выбранный хьюмидор.'
                  }}
                </p>
              </div>
              <Tag
            ...
            <div
              ...
              <div
                ...
                <ul class="mt-2 list-disc pl-5 space-y-1">
                  <li>Обычно хватает двух позиций; остальное можно добавить из раздела «База сигар».</li>
                  <li>Можно нажать «Завершить» или «Пропустить», если сигары не нужны сейчас.</li>
                </ul>
              </div>
            </div>
          </div>

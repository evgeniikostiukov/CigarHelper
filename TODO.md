...
- [ ] **Обзоры:** удаление для автора — мягкое (строка в БД сохраняется: флаг/`DeletedAt`/аналог), не показывать в списках и публичных местах; при необходимости восстановление только staff или только из админки.

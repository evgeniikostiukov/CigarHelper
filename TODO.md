...
- [x] **2026-03-30** — Repo hygiene: добавлены хуки для .NET: `dotnet format` (только staged `*.cs` через `--include`) на pre-commit и `dotnet build CigarHelper.sln -c Release` на pre-push.
